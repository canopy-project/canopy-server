...
func AddRoutes(r *mux.Router, cfg config.Config, pigeonSys jobqueue.System) error {
    ...
    forwardAsPigeonJob("/api/org/{name}/team/{alias}/members", "GET", "GET:api/org/name/team/alias/members")
    forwardAsPigeonJob("/api/org/{name}/team/{alias}/members", "POST", "POST:api/org/name/team/alias/members")
    forwardAsPigeonJob("/api/org/{name}/teams", "GET", "GET:api/org/name/teams")

...
func InitJobServer(cfg config.Config, pigeonServer jobqueue.Server) error {
    ...
    routes := map[string]jobqueue.HandlerFunc{
        ...
        "POST:api/org/name/create_team": rest.RestJobWrapper(rest.POST__api__org__name__add_team),
        ...
        "GET:api/org/name/team/alias/members": rest.RestJobWrapper(rest.GET__api__org__name__team__alias__members),
        "POST:api/org/name/team/alias/members": rest.RestJobWrapper(rest.POST__api__org__name__team__alias__members),
        "GET:api/org/name/teams": rest.RestJobWrapper(rest.GET__api__org__name__teams),
